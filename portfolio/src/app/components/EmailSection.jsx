    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/P1R47E">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/yoseph-tesfaye-2656b5319/">
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input
                ...
                placeholder="Yosephtesfaye27@gmail.com  : can reach my personal email"
              />
            </div>
            <div className="mb-6">
              <label
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                id="message"
                className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                placeholder="Let's Grab a coffee and discuss..."
              />
            </div>
            <button
              type="submit"
